namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageRealtyPrice1MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageRealtyPrice1MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageRealtyPrice1MethodsWrapper(Process process)
			: base(process) {
